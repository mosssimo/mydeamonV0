...
def process_event(assistant, led, event):
    ...
    if event.type == EventType.ON_START_FINISHED:
        ...
        #led.state = Led.ON  # Listening.
         ...
         #This is where I need to put the text onto the server     
         api_url_base = 'http://1d26268d.ngrok.io'
         parameters = {"Data":event.args['text'],"isComplete":False}
         ...
         print(response)
         print(response.text)
         tts.say('You said' + event.args['text'])
...
def main():
    ...
    with Board() as board, Assistant(credentials) as assistant:
        tts.say('Hello Paul, how are you today!')
