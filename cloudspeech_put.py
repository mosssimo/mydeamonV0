...
def main():
    tts.say('Hello Paul, how are you.',volume=20,lang="en-GB")
    ...
    with Board() as board:
        while True:
            if hints:
                ...
                tts.say('Say something.',volume=20,lang="en-GB")
            text = client.recognize(language_code=args.language,
                                    hint_phrases=hints)
            if text is None:
                logging.info('You said nothing.',lang="en-GB")
                tts.say('You said nothing.',volume=20,lang="en-GB")
                continue
            ...
            tts.say('You said, ' + text + ".",volume=20,lang="en-GB")
